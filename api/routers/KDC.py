...
keyAlice = b'E8B6C00C9ADC5E75BB656ECD429CB1643A25B111FCD22C6622D53E0722439993'
keyBob = b'key=67BCB464EB033B8779F284186CB8996728BDC4C5F9DF58DE34497A82C2815E82'
KS = b'C29B85EE8FA5A6D7E2805E4ACEC8A7E41883E8336891B23EFD5065F4FB6C6682'

masterAlice = keyAlice[:32]
masterBob = keyBob[:32]
sessionKey = KS[:32]
...
aliceMessage = open("msg2a.txt", "w")
aliceMessage.write(str([IDa, IDb, N1, sessionKey]))
aliceMessage.close()

aliceMessage = open("msg2a.txt", "rb")
aliceNotEncryptedMessage = aliceMessage.read()
aliceMessage.close()
